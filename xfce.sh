...
wget https://raw.githubusercontent.com/akhilraghav0/termux_gui/master/ubchromiumfix.sh && chmod +x ubchromiumfix.sh
...
vncpasswd
wget -q https://raw.githubusercontent.com/akhilraghav0/termux_gui/master/.profile -O $HOME/.profile.1 > /dev/null
